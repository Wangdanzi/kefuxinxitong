<template>
  <div class="users">
    ...
    <div style="margin-top:50px">
      <el-table ref="multipleTable" :data="tableData3" border stripe>
        <el-table-column type="selection" width="30"></el-table-column>
        <el-table-column label="编号" width="50">
          <!-- <template slot-scope="scope">{{ scope.row.date }}</template> -->
        </el-table-column>
        <el-table-column prop="name" label="反馈方" width></el-table-column>
        <el-table-column prop="name" label="客户姓名"></el-table-column>
        <el-table-column prop="name" label="来电号码" width></el-table-column>
        <el-table-column prop="name" label="城市" width></el-table-column>
        <el-table-column prop="name" label="机构名称" width></el-table-column>
        <el-table-column prop="name" label="创建时间" width></el-table-column>
        <el-table-column prop="name" label="更新时间" width></el-table-column>
        <el-table-column prop="name" label="租约ID" width></el-table-column>
        <el-table-column prop="name" label="技能组" width></el-table-column>
        <el-table-column prop="name" label="工单类型" width></el-table-column>
        <el-table-column prop="name" label="工单状态" width></el-table-column>
        <el-table-column prop="name" label="受理员工" width></el-table-column>
        <el-table-column fixed="right" label="操作">
          <template slot-scope="scope">
            <el-button type="text" @click="Roles.vue" size="small">详情</el-button>
          </template>
        </el-table-column>
        <router-view/>
      </el-table>
