              ...
              <el-button @click="retreat = true">机构转退租规则</el-button>
               ...
               <el-button @click="lease = true">租约</el-button>
                <el-dialog
                  ...
                  :modal="false"
                  :close-on-click-modal="false">
                  <p>租约id：</p><el-tag type="info">标签三</el-tag>
                  <p>未付期数：</p><el-tag type="info">标签三</el-tag>
                  <p>协议：</p><el-tag type="info">标签三</el-tag>
                  <p>金融渠道：</p><el-tag type="info">标签三</el-tag>
                  <p>工作站：</p><el-tag type="info">标签三</el-tag>
                  <p>分期：</p><el-tag type="info">标签三</el-tag>
                  <p>合同到期时间：</p><el-tag type="info">标签三</el-tag>
                  <p>租约维护人：</p><el-tag type="info">标签三</el-tag>
                  <p>签约人：</p><el-tag type="info">标签三</el-tag>
                  <p>开始日期：</p><el-tag type="info">标签三</el-tag>
                  <p>结束日期：</p><el-tag type="info">标签三</el-tag>
                  <p>租期时长：</p><el-tag type="info">标签三</el-tag>
                  <p>租客姓名：</p><el-tag type="info">标签三</el-tag>
                  <p>手机号码：</p><el-tag type="info">标签三</el-tag>
                  <p>小区名称：</p><el-tag type="info">标签三</el-tag>
                  <p>公寓名称：</p><el-tag type="info">标签三</el-tag>
                  <p>信息任务执行状态：</p><el-tag type="info">标签三</el-tag>
                  <p>小区地址：</p><el-tag type="info">标签三</el-tag>
                  <p>房屋详情：</p><el-tag type="info">标签三</el-tag>
                  <p>付款状态：</p><el-tag type="info">标签三</el-tag>
                  <p>租约类型：</p><el-tag type="info">标签三</el-tag>
                  <p>首次付款时间：</p><el-tag type="info">标签三</el-tag>
                  <p>预约审核时间：</p><el-tag type="info">标签三</el-tag>
                  <p>退租时间：</p><el-tag type="info">标签三</el-tag>
                  <p>流程状态：</p><el-tag type="info">标签三</el-tag>
                  <p>逾期天数：</p><el-tag type="info">标签三</el-tag>
                  <p>审核状态：</p><el-tag type="info">标签三</el-tag>
                  <p>租约状态：</p><el-tag type="info">标签三</el-tag>
                  <!-- <el-table :data="leaseData">
                    <el-table-column property="date" label="日期" width="150"></el-table-column>
                    <el-table-column property="name" label="姓名" width="200"></el-table-column>
                    <el-table-column property="address" label="地址"></el-table-column>
                  </el-table> -->
          ...
          <div class="top">
           <ul>
             ...
             <li>
                ...
                <el-dialog title="进度记录" :visible.sync="particulars"
                 width="1000px"
                 :modal="false">
                 <!-- 转租想详情记录弹框表格第一个  -->
                 <el-table
...
<el-dialog title="租约" :visible.sync="dialogTableVisible">
  <el-table :data="gridData">
    <el-table-column property="date" label="日期" width="150"></el-table-column>
    <el-table-column property="name" label="姓名" width="200"></el-table-column>
    <el-table-column property="address" label="地址"></el-table-column>
